...
import { withAuditedRequest, type AuditSpanHandle } from '@/lib/observability/audit';
...
export async function POST(req: NextRequest) {
  return withAuditedRequest(
    req,
    { module: 'generation', operation: 'generation.classroom-job' },
...
async function post(req: NextRequest, audit: AuditSpanHandle) {
  ...
  try {
    ...
    after(() => runClassroomGenerationJob(jobId, body, baseUrl, audit.context.auditRunId));
